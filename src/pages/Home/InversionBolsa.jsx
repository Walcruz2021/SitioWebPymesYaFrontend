...
const InversionBolsa = () => {
  return (
    <>
      ...
      <p>Dicha imagen es otorgada por la página<a href="https://finviz.com" target="_blanck">finviz</a>la cual, nos porporciona toda la información necesaria a la ahora de invertir. En este caso a modo de ejemplo, se elegirá a la empresa Microsoft y analizaremos un poco su estado patrimonial superficialmente</p>
      <img src={finviz}/>

      <h3>SHORT FLOAT</h3>
      <p>Porcentaje de acciones en circulación de una compañia que han sido vendidas en corto por los inversores. 
        La venta en corto es una estrategia utilizada por los inversores que creen que el precio de una acción 
        disminuirá en el futuro.</p>
      <p>Cuando los inversores venden en corto una acción, están tomando prestados acciónes de un corredor y la 
        venden en el mercado con la esperanza de recomprarlas a un precio más bajo en el futuro. Si tienen éxito, 
        obtendrán una ganancia al devolver las acciones prestadas al corredor</p>
      ...
      <p>Indica que hay menos inversores que estén vendiendo en corto la acción. Lo que sugiere un sentimiento + positivo</p>
      <p>En términos generales, un short float por encima del 20% se considera relativamente alto, pero esto puede variar según el contexto. 
        Lo más importante es evaluar el short float en el contexto de la empresa en cuestión, su industria, la situación del mercado y otros factores relevantes antes de tomar decisiones de inversión. 
        Un alto short float puede ser una señal de riesgo potencial, pero no debe ser el único factor en su análisis de inversión.</p>
      <img src={sFloat}/>
      ...
      <p>Se considera como una señal de que el activo está sobrecomprado, lo que implica que puede haber habido un 
        ...
        cercano</p>
      <p className="blackP" >NOTA: Generalmente se usa en periodos de índices pero tambien puede adaptarse a periodos más cortos o más 
        largos</p>
      <img src={rsi}/>
      
      <h3>TARGET PRICE</h3>
      <p>Es una estimación, se utiliza como una guía para los inversionistas y traders al tomar decisiones sobre 
        comprar, vender o mantener una acción</p>
      <p>Si el TARGET price es mayor que el precio actual de mercado, podría ser una señal de que espera que la 
        acción se aprecie, y sea una buena oportunidad de compra</p>
      <p>Por otro lado si TP es menor PAM podría indicar que se espera que la acción se deprecie y ser una señal de 
        venta</p>
      ...
      <p>Es un indicador importante para los inversores y traders, ya que porporciona una idea de la liquidez y la 
        actividad comercial de una acción o valor financiero</p>
      <p className="blackP">ALTO</p>
      
      <p>Indica mayor liquidez y mayor interés de los participantes del mercado en la acción, lo que puede ser 
        una señal de mayor actividad y oportunidades comerciales</p>
      
      <p className="blackP">BAJO</p>
      <p>Indica menor liquidez y menor interés en la acción, lo que puede indicar una menor liquidez y un menor 
        interés en la acción, lo que puede dificultar la compra y venta de acciones en grandes cantidades sin afectar 
        el precio</p>
        <img src={avgVolume}/>

      <h3>OVERSOLD</h3>
      <p>Se utiliza para describir una situación en la que el precio de una acción o valor financiero ha caído en 
        exceso y se considera que está por debajo de su valor intrínsico o fundamental subyacente</p>
      <p>Cuando una acción esta oversold se considera que ha habido una presión excesiva de venta, lo que ha llevado 
